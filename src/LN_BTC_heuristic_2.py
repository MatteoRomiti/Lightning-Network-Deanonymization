...
output_file_3b = results_folder + 'heuristic_2_results.csv'
...
output_file_8 = results_folder + 'proxy_heuristic_2_entity_node_conf.json'
output_file_9 = results_folder + 'proxy_heuristic_2_node_entity_conf.json'
