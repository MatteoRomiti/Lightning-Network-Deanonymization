# This script fetches settlement txs of funded addresses from the GraphSense
# API (access token needed) starting from a list of funding txs and channels
# and creates a list of settlement addresses and a dict of settlement
# transactions.
...
input_dir_1 = '../data/layer_1/'
input_dir_2 = '../data/layer_2/'
